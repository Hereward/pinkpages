...
<div class="content">  
  ...
  {if ($related_class_count > 0)}
             <h2 style="font-size:14px; font-weight:bold; padding:0; color:dimgray; margin: 10px 0 0 25px;">Related Classifications</h2>
             <div style="margin:10px 0px 5px 0px; font-size:11px;">
