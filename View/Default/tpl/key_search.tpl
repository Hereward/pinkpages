...
*}
	...
	<ul class="search">
        ...
        <input class="search-button" hspace="10" src="{$IMAGES_PATH}sidesearch.gif" type="image" name="Submit" id="Submit" value="Search" />
				...
				<label for="Search1" generated="true" class="error" style="background-color:#E9138F; font-weight:bold; color:black; padding:3px; border:1px solid #E9138F; left:25px; top:-30px; z-index:10; position:relative; display: none;">Please enter a keyword or business name</label>				  					
