...
fb_iframe = "<iframe src='http://www.facebook.com/plugins/like.php?href=$facebook_url' scrolling='no' frameborder='0' style='border:none; width:450px; height:80px'></iframe>";
