...
<div class="content">
<h4 class="h4reversed" align="center"><b>Add Demo Listing</b></h4>
...
<li> 
   <label>Address   <font color="#FF0000">*</font></label>
	<input  id="field3" type="text" name="address" value="{$address}" class="textfieldshort"/>
...
<li>
    <label>Suburb</label>
	<input type="text" name="suburb" value="{$suburb}" class="textfieldshort" />
</li>

<li>
    <label>State</label>
	<input type="text" name="state" value="{$state}" class="textfieldshort" />
</li>
...
<li>
    <label>Logo  <font color="#FF0000">*</font></label>
    
   	 <input  id="field12" type="file" name="logo" class="textfieldshort" size='62'  /> 
	 <div><font color="#FF0000" size="-6">(Please upload Logo)</font></div> 
</li>
...
<ul class="controlbar">
		<div align="left">
		&nbsp;&nbsp;<input type="submit" name="submit" value="Click to display your ad! " class="controlgrey-demo" onclick="setName(this.value)" />
