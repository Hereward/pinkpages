...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'info@sydneypinkpages.com.au';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Sydney Pink Pages';
  ...
  function SmtpSend($header, $body) {
    //include_once($this->PluginDir . 'class.smtp.php'); // Not needed with autoloader defined
    $error = '';
    $bad_rcpt = array();
 ...
 //   $this->smtp->do_debug = $this->SMTPDebug;
  ...
  function SetLanguage($lang_type, $lang_path = '/language/') {
    //$lang_path = THIRD_PARTY_LIB_PATH.$lang_path; //to make it work on my local windows machine - vinod
  ...
  function CreateHeader() {
    ...
    if(($this->Mailer == 'mail') && (count($this->bcc) > 0)) {
