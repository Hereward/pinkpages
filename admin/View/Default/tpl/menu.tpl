...
{elseif  ($do eq 'Admin' AND $action eq 'sitePerformanceReport')||($do eq 'Admin' AND $action eq 'pagePopularityReport')||($do eq 'Admin' AND $action eq 'fetchUniqueClients')||($do eq 'Admin' AND $action eq 'classificationStats')||($do eq 'Admin' AND $action1 eq 'clients_in_specific_locality')||($do eq 'Admin' AND $action eq 'failed_searches')||($do eq 'Admin' AND $action eq 'count_listing')||($do eq 'Admin' AND $action eq 'count_listings_in_vertical')||($do eq 'Admin' AND $action eq 'count_listings_in_classification')||($do eq 'Admin' AND $action eq 'count_listings_in_locality')||($do eq 'Admin' AND $action1 eq 'search_locality_based_clients_form')||($do eq 'Admin' AND $action1 eq 'search_locality_based_clients')||($do eq 'Admin' AND $action1 eq 'search_within_a_locality_count')||($do eq 'Classification' AND $action eq 'regionReport')||($do eq 'Classification' AND $action eq 'ctrReport')}
	...
	{elseif ($do eq 'AdminListing' AND $action1 eq 'csvFormShow') || ($do eq 'AdminListing' AND $action1 eq 'csvFileUpload') ||  ($do eq 'AdminListing' AND $action1 eq 'import')||  ($do eq 'AdminListing' AND $action1 eq 'Edit')||  ($do eq 'AdminListing' AND $action1 eq 'delete')||  ($do eq 'AdminListing' AND $action1 eq 'editAdd')||  ($do eq 'AdminListing' AND $action1 eq 'search')||  ($do eq 'AdminListing' AND $action1 eq 'searchList') || ($do eq 'AdminListing' AND $action1 eq 'addClassification')|| ($do eq 'AdminListing' AND $action1 eq 'rankBusiness')|| ($do eq 'AdminListing' AND $action1 eq 'addRank')}
