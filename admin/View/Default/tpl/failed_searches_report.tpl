...
{/literal}
<div class="content">
<h3><center><b>Failed Searches Report (12 Months)</b></center></h3>
<br />
<form action="{$failed_searches_report_action}" id="" name="classificationReport" method="post" onsubmit="return validate();">
<table class="datatable" width="100" border="0" cellpadding="0" cellspacing="0" align="center">
		...
		<tr>
		 <td colspan="2" align="center"><input type="submit" value=" Generate Failed Searches Report "  ></td>
		</tr>
</table>
