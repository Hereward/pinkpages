...
<table class="datatable" width="100" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    {foreach from=$values item=key}
     <tr class="{if $j % 2==0}{else}odd{/if}">
        ...
        <td><a href="{$edit_url}={$key.group_id}" ><font color="#CC3399"><b>Edit</b></a>/<a href="#" onmousedown="del('{$delete}={$key.group_id}')"><font color="#CC3399"><b>Delete</b></font></a></td>
