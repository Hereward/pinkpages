...
<table class="datatable" width="100" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    {foreach from=$values item=key}
      ...
      <td>{$key.service_name}</td>
	  	<td align="right"><a href="#" onmousedown="del('{$delete_business_service}&ID={$key.service_id}')"> <font color="#CC3399"><b>Delete</b></font></a> 
	  </td> 
