...
<h3 align="left">Operation Hour History</h3>
<table class="datatable" width="100" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    {foreach from=$values item=key}
     ...
     <tr class="odd">
			...
			<td class="open" rel="{$js}" name="show">view
				<div id="open{$js}" style="display:none;">				    
					...
					{foreach key=ch from=$keyOld item=chOld}
					<tr>
						<td>{$ch}</td>
						<td>{$chOld}</td>
					</tr>
			...
			<td class="openNew" rel="{$js}" name="showNew">view
